...
import { WorkspaceFileMetadata } from "@/lib/hrDocuments";
import {
  FileSpreadsheet,
  FileText,
  Download,
...
export default function HRWorkspaceSection() {
  ...
  const fetchEmployeesAndFiles = async () => {
    try {
      ...
      if (empData.success && empData.employees.length > 0) {
        ...
        if (!selectedEmpId) {
          setSelectedEmpId(empData.employees[0].empId);
        }
      }
      if (fileData.success) {
  ...
  return (
    <div className="space-y-6">
      {/* Top Banner Card */}
      <div className="bg-[#331E1E] text-white p-6 rounded-2xl shadow-by-lg border border-[#442828] flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-3">
          <div className="bg-[#261414] px-3.5 py-2 rounded-xl border border-[#442828] text-right">
            <div className="text-[10px] text-[#A89898]">Vault Storage</div>
            <div className="text-xs font-bold text-[#A2FC4B] font-mono">./workspace/</div>
          </div>
          <button
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        <div className="bg-white p-4 rounded-2xl border border-[#E2EAD6] shadow-by flex items-center gap-3">
          ...
          <div>
            <div className="text-xl font-bold text-[#331E1E]">{employees.length}</div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        <div className="lg:col-span-5 bg-white p-5 rounded-2xl border border-[#E2EAD6] shadow-by flex flex-col justify-between">
          <div>
            <div className="flex items-center justify-between mb-3">
              <div className="flex items-center gap-2">
                ...
                <div>
                  <h3 className="text-sm font-bold text-[#331E1E]">Employee Master Data</h3>
                  <span className="text-[10px] text-emerald-700 font-bold uppercase">
                    Microsoft Excel (.xls)
                  </span>
                </div>
              </div>
              <span className="text-[10px] bg-[#F6FAF0] text-[#331E1E] px-2 py-0.5 rounded-full border border-[#E2EAD6] font-mono">
                Multi-Worksheet
              </span>
            </div>
            ...
            <div className="bg-[#F6FAF0] p-3 rounded-xl border border-[#E2EAD6] space-y-2 mb-4 text-xs">
              <div className="flex items-center justify-between text-[#331E1E]">
              ...
              <div className="flex items-center justify-between text-[#331E1E]">
                ...
                <span className="font-bold text-[#331E1E]">.xls</span>
              </div>
            </div>
          </div>

          <div className="flex items-center gap-2 pt-2 border-t border-[#E2EAD6]">
            <a
            ...
            <button
              ...
              className="flex items-center gap-1.5 px-3 py-2.5 bg-[#331E1E] hover:bg-[#442828] text-[#A2FC4B] font-bold text-xs rounded-xl transition-all cursor-pointer"
        ...
        <div className="lg:col-span-7 bg-white p-5 rounded-2xl border border-[#E2EAD6] shadow-by flex flex-col justify-between">
          <div>
            <div className="flex items-center justify-between mb-3">
              <div className="flex items-center gap-2">
                ...
                <div>
                  <h3 className="text-sm font-bold text-[#331E1E]">Official Letters &amp; Dossiers</h3>
              ...
              <div className="flex items-center gap-2">
                ...
                <select
                  ...
                  className="px-2.5 py-1.5 bg-[#F6FAF0] border border-[#E2EAD6] rounded-xl text-xs font-bold text-[#331E1E] focus:outline-none focus:ring-2 focus:ring-[#A2FC4B]"
                >
                  {employees.map((emp) => (
            ...
            {selectedEmployee && (
              <div className="bg-[#F6FAF0] px-3 py-2 rounded-xl border border-[#E2EAD6] mb-3 flex items-center justify-between text-xs">
                <div className="flex items-center gap-2">
                  <span className="font-bold text-[#331E1E]">{selectedEmployee.name}</span>
                  <span className="text-[11px] bg-[#331E1E] text-[#A2FC4B] px-1.5 py-0.2 rounded font-mono font-bold">
                    {selectedEmployee.empId}
                  </span>
                </div>
                <div className="text-[11px] text-[#706161]">
                  Role: <span className="font-semibold text-[#331E1E]">{selectedEmployee.designation}</span> &bull; {selectedEmployee.department}
                </div>
              </div>
            )}
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-2.5 mb-3">
              {/* Doc 1: Appointment Letter */}
              <div className="p-3 bg-[#F6FAF0] rounded-xl border border-[#E2EAD6] flex flex-col justify-between">
                <div>
                  <div className="font-bold text-xs text-[#331E1E] mb-1">Appointment Letter</div>
                  <p className="text-[11px] text-[#706161] line-clamp-2">
                    Official offer letter with terms, designation, studio location &amp; credentials.
                  </p>
                </div>
                <div className="flex items-center gap-1.5 mt-3 pt-2 border-t border-[#E2EAD6]">
                  <a
                    href={`/api/workspace/download?generate=appointment_letter&empId=${selectedEmployee?.empId}`}
                  ...
                  <button
                    onClick={() => handleSaveToWorkspace("appointment_letter")}
                    title="Save to folder vault"
                    className="p-1.5 bg-[#331E1E] hover:bg-[#442828] text-[#A2FC4B] rounded-lg text-[11px] cursor-pointer"
                  >
              ...
              <div className="p-3 bg-[#F6FAF0] rounded-xl border border-[#E2EAD6] flex flex-col justify-between">
                <div>
                  <div className="font-bold text-xs text-[#331E1E] mb-1">Employee Dossier</div>
                  <p className="text-[11px] text-[#706161] line-clamp-2">
              ...
              <div className="p-3 bg-[#F6FAF0] rounded-xl border border-[#E2EAD6] flex flex-col justify-between">
                <div>
                  <div className="font-bold text-xs text-[#331E1E] mb-1">Agency NDA</div>
                  <p className="text-[11px] text-[#706161] line-clamp-2">
          ...
          <div className="text-[11px] text-[#706161] bg-[#F6FAF0] p-2.5 rounded-xl border border-[#E2EAD6] flex items-center justify-between">
            <span>Documents are styled with B &amp; Y agency typography and open natively in Word &amp; Google Docs.</span>
            <span className="font-bold text-[#331E1E]">Print &amp; Sign Ready</span>
          </div>
        </div>
      </div>
      ...
      <div className="bg-white rounded-2xl border border-[#E2EAD6] shadow-by p-5 space-y-4">
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 border-b border-[#E2EAD6] pb-3">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <h3 className="text-sm font-bold text-[#331E1E]">Vault Document Repository</h3>
              <p className="text-[11px] text-[#706161]">
                Files stored on disk at <code className="bg-[#F6FAF0] px-1.5 py-0.5 rounded text-[#331E1E] font-mono">./workspace/</code>
              </p>
            </div>
          </div>

          <div className="text-xs text-[#706161]">
            Total Archived: <strong className="text-[#331E1E]">{files.length} documents</strong>
          </div>
        </div>
        ...
        {files.length === 0 ? (
          <div className="text-center py-10 text-xs text-[#706161]">
            ...
            <p className="font-semibold text-[#331E1E]">Vault repository is currently empty</p>
            <p className="mt-1">
              Click <span className="font-bold text-[#331E1E]">"Save to Vault"</span> above to stream and store Excel master data or Word appointment letters.
            </p>
          </div>
        ) : (
                ...
                {files.map((file, idx) => (
                  <tr key={idx} className="hover:bg-[#F6FAF0]/60 transition-colors">
                    ...
                    <td className="py-2.5 px-3">
                      ...
                      >
                        {file.category === "excel" ? "Excel .xls" : "Word .doc"}
                      </span>
                    </td>
                    <td className="py-2.5 px-3 text-[#331E1E]">
                      {file.empId ? (
                        <span className="px-2 py-0.5 rounded bg-[#331E1E] text-[#A2FC4B] font-mono text-[10px] font-bold">
                          {file.empId}
                        </span>
                      ) : (
